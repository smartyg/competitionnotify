...
class SpeedSkatingResults:
	...
	@staticmethod
	async def _apiSeasonBests(session: aiohttp.ClientSession, skater: int|classes.NameClass, distance: int|None = None, start: int|None = None) -> classes.BestTimesClass:
		if isinstance(skater, classes.NameClass):
			skater_id = skater._id
		else:
			skater_id = skater
	...
	@staticmethod
	async def getPersonalRecord(skaters: list[int]|list[classes.NameClass]|int|classes.NameClass, distance: classes.DistanceClass|int|None = None) -> list[classes.BestTimesClass]:
		distance_value: int|None
		if isinstance(distance, int):
			distance_value = classes.DistanceClass(distance)._distance
		elif isinstance(distance, classes.DistanceClass):
			distance_value = distance._distance
		else:
	...
	@staticmethod
	async def getSeasonBest(skaters: list[int]|list[classes.NameClass]|int|classes.NameClass, distance: classes.DistanceClass|int|None = None, season: int|None = None) -> list[classes.BestTimesClass]:
		distance_value: int|None
		if isinstance(distance, int):
			distance_value = classes.DistanceClass(distance).value
		elif isinstance(distance, classes.DistanceClass):
	...
	@staticmethod
	async def getDistanceResult(skaters: list[int]|list[classes.NameClass]|int|classes.NameClass, distance: classes.DistanceClass|int, season: int|None = None) -> list[classes.ResultsClass]:
		distance_value: int
		if isinstance(distance, int):
			distance_value = classes.DistanceClass(distance)._distance
		elif isinstance(distance, classes.DistanceClass):
