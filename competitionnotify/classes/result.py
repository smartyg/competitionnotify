...
class ResultClass(base.BaseClass):
	_distance: distance.DistanceValueClass = attrs.field(converter=distance.DistanceValueClass_converter, validator=attrs.validators.instance_of(distance.DistanceValueClass)) #type: ignore [misc]
	_time: time.TimeClass = attrs.field(converter=time.TimeClass_converter, validator=attrs.validators.instance_of(time.TimeClass)) #type: ignore [misc]
	_date: datetime.date = attrs.field(converter=utils.datetime_converter, validator=attrs.validators.instance_of(datetime.date)) #type: ignore [misc]
...
class BestTimesClass(BaseSkaterClass):
	...
	_records: dict[distance.DistanceValueClass, ResultClass] = attrs.field(converter=convert_to_ResultClass_dict, validator=attrs.validators.deep_mapping( #type: ignore [misc]
	...
	def getDistance(self, distance: distance.DistanceValueClass) -> ResultClass|None:
		return self._records.get(distance, None)
...
class ResultsClass(BaseSkaterClass):
	...
	_distance: distance.DistanceValueClass = attrs.field(converter=distance.DistanceValueClass_converter, validator=attrs.validators.instance_of(distance.DistanceValueClass)) #type: ignore [misc]
	_results: list[ResultClass] = attrs.field(converter=convert_to_ResultClass_list, validator=attrs.validators.deep_iterable( #type: ignore [misc]
...
class CompetitionClass:
	...
	_startdate: datetime.date = attrs.field(converter=utils.datetime_converter, validator=attrs.validators.instance_of(datetime.date)) #type: ignore [misc]
	_enddate: datetime.date = attrs.field(converter=utils.datetime_converter, validator=attrs.validators.instance_of(datetime.date)) #type: ignore [misc]
...
class CompetitionsClass(BaseSkaterClass):
	_season: int = attrs.field(validator=attrs.validators.instance_of(int))
	_competitions: list[CompetitionClass] = attrs.field(converter=convert_to_CompetitionClass, validator=attrs.validators.deep_iterable( #type: ignore [misc]
