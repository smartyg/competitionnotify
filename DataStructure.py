...
class HomeVenues(BaseDataStructure):
	...
	def update(self, address: dict, code: str, name: str):
		...
		if self.columnHasValue('code', code.encode()):
			selector = self._table['code']==code.encode()
...
class Skaters(BaseDataStructure):
	...
	def filter(self, venue: str, homeVenueFilter: str|list|None = None, categoryFilter: str|list|None = None, clubCodeFilter: str|list|None = None, disciplineCodeFilter: str|None = None, invitees: list|None = None) -> list:
